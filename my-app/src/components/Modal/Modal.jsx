...
export default function Modal() {
  ...
  return (
    <>
      ...
      <ModalComponent visible={isModal} onClose={onClose} />
    </>
  );
}

const ModalComponent = ({ visible = false, onClose }) => {
  const onKeydown = ({ key }) => {
    switch (key) {
      case "Escape":
        onClose();
            ...
            <div className="modal_content">
              <div className="modal_content_fragment">
                ...
                <p>
                  ...
                  ООО «Гросс маркет» (далее — «Гросс маркет»), могут получитьо
              ...
              <div className="modal_content_fragment">
                ...
                <p>
                  ...
                  «Гросс маркет»), или его аффилированным лицом, предоставляющим
                  соответствующий Сервис в иных юрисдикциях. С информацией о
                  том, какое лицо предоставляет тот или иной Сервис, Вы можете
                  ознакомиться в условиях использования соответствующего
                  Сервиса.
                </p>
              </div>
              <div className="modal_content_fragment">
